...
def get_flann_matrix_img2img(img_bev = r"/home/lee/Documents/work/programs/camera_img2img_matrix/bev.jpg",img = r"/home/lee/Documents/work/programs/camera_img2img_matrix/test.jpg"):#/media/lee/2T1/dataset/tcs/images
    imgs_bev = []
...
if __name__ == '__main__':
    ...
    print(m)
    img = cv2.imread(r"/home/lee/Documents/work/programs/camera_img2img_matrix/test.jpg",0)
    print(img.shape[0],img.shape[1])
    # result = cv2.warpPerspective(img,m,(img.shape[1],img.shape[0]))
    result = cv2.warpPerspective(img,m,(562,720))
    cv2.imshow("i",result)
    cv2.waitKey(0)
    print(m)